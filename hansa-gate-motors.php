...
$brand = "hansa";
$pageTitle = "Hansa Gate Motors | Buy Install Repair";
$metaTitle = "$brand Gate Motor Repairs and Installation of Gate Motors";
$metaDescription = "Hansa Gate Motors and more - We supply,install and repair gate motors of all major brands throughout South Africa. Centurion,Gemini,Hansa - you name it.";
...
<?php
    ...
    include "include/hansa-products-page.php";
?>
