...
$brand = "centurion";
$pageTitle = "Centurion Gate Motors | Buy Install Repair";
$metaTitle = "$brand Gate Motor Repairs and Installation of Gate Motors";
$metaDescription = "Centurion Gate Motors and more - We supply,install and repair gate motors of all major brands throughout South Africa. Centurion,Gemini,Hansa - you name it.";
...
<?php
    ...
    include "include/centurion-products-page.php";
?>
