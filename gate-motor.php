...
<h1>Gate Motor and Gate Automation</h1>
<div style="float:right;width:380px">
    ...
    <div style="margin:15px">
        ...
        <p>
            Gate Motor Guru aims to be the number one source of information for everything gate motor related, whether
            it is selecting the right motor, getting help with your gate problems.
        </p>
        <p> Our <strong>Gate Motor Experts</strong> are standing by to help you get quotes and fix your broken gate motor.
        </p>
    </div>
    <!--content end -->
    <b class="rbottom">
