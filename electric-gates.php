...
$pageTitle = "Electric Gates | Gate Motors Repairs and Installation";
$metaTitle = "Electric Gate Repairs and Installation of Gate Motors";
$metaDescription = "Electric Gates - We supply,install and repair electric gate motors of all major brands throughout South Africa. Centurion,Gemini,Hansa - you name it.";
$metaKeywords = "electric gate motor,electric gates,electric gate";

include_once "include/header.php";
?>

<h1>Electric Gates, Gate Motors and Automation</h1>
<div style="float:right;width:380px">
    ...
    <div style="margin:15px">
        <p>
            Whether it is help with a sliding electric gate motor or a swing gate, you've come to the right place.
        </p>

        <p>
            Gate Motor Guru aims to be the number one source of information for everything electric gate related, whether
            it is selecting the right motor, getting help with your gate problems.
        </p>
        <p> Our <strong>Electric Gate Experts</strong> are standing by to help you get quotes and fix your broken gate motor.
        </p>
    </div>
    <!--content end -->
    <b class="rbottom">
...
Find the
<h2 style ="margin-left:20px">Electric Gate Motor Guru</h2>
...
<p>
    If you are just looking for some general information for your <strong>electric gate motor</strong> you should try our
    forums. If you need personal attention and great service try one of our approved <em>electric gates</em> Guru's.
