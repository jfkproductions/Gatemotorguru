...
$pageTitle = "Automatic Gates | Gate Motors Repairs and Installation";
$metaTitle = "Automatic Gates Repairs and Installation of Gate Motors";
$metaDescription = "We supply,install and repair Automatic Gate Motors of all major brands throughout South Africa. Centurion,Gemini,Hansa - you name it.";
$metaKeywords = "gate motor,automatic gates,gate automation";

include_once "include/header.php";
?>

<h1>Automatic Gates and Gate Motors</h1>
<div style="float:right;width:380px">
    ...
    <div style="margin:15px">
        <p>
            Whether it is help with a sliding automatic gate motor or a swing gate, you've come to the right place.
        </p>

        <p>
            Gate Motor Guru aims to be the number one source of information for everything gate automation related, whether
            it is selecting the right motor, getting help with your automatic gate problems.
        </p>
        <p> Our <strong>Automatic Gate Experts</strong> are standing by to help you get quotes and fix your broken gate motors.
        </p>
    </div>
    <!--content end -->
    <b class="rbottom">
...
Find the
<h2 style ="margin-left:20px">Automatic Gate Guru</h2>
...
<h2>Automatic Gate Motors Brands</h2>
<?php showBrands(); ?>
...
<p>
    If you are just looking for some general information for your <strong>automatic gates</strong> you should try our
