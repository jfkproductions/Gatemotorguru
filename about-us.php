...
$pageTitle = "About us -  Gate Motor Guru";
$metaTitle = "Gate Motor Guru - About Us";
$metaDescription = "About Gate Motor Guru - We Supply, Install and Repair Gate Motors throughout South Africa. All major brands such as centurion, gemini and more.";
$metaKeywords = "about gate motor guru";
...
?>
  ...
  <tr>
  <td colspan="2">
	<h1>About Us - Gate Motor Guru</h1>
		<h2>What we do</h2>
			<p>
...
?>
                ...
                PLEASE PHONE <u><?= $assistantName ?></u>, MY ASSISTANT: <b> - 079 613 7845 - </b><br/>
                &nbsp;&nbsp;<b><?= $assistantGenderUpper?> will help you with all Prices, Quotes, Booking of a Technician and all enquiries.</b>
                </div>
<?php
...
?>
			...
			<br/>Contact Andries on: 083 327 2921 (personal cell), 079 613 7845 (business cell)<br/>
                        ...
                        <br/>
			ARE YOU A GATE MOTOR INSTALLER, AND WOULD LIKE TO DO JOBS FOR US?<br/>
