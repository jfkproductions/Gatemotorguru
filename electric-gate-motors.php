...
$defWhatWeDo = "We supply, install, repair Electric Gate Motors from Pretoria to Sandton."; //goes into title and meta description
$defMetaKeywords = "electric gate motors, gate motor";
$defCompanyShort = "Gate Motor Guru - Electric Gate Motors - Repairs Replace Installs.";

$mainPageHeading = "Electric Gate Motors | We Install,Supply and Repair .";
$mainPageParagraph = "Sliding and swinging electric gate motors, in Pretoria, Centurion, Midrand, Fourways, up to Sandton.";
$mainPageParagraph .= "<br/><br/>All major brands of electric gate motors including Centurion Gate Motors, Gemini and more.";

$pageTitle = "Electric Gate Motor Guru | Electric Gate Motors Repairs and Installation";
$metaTitle = "Electric Gate Motor Repairs and Installation of Gate Motors";
$metaDescription = "Electric Gate Motor Guru - We supply,install and repair electric gate motors of all major brands throughout South Africa. Centurion,Gemini,Hansa - you name it.";
$metaKeywords = "electric gate motor,electric gate motors,electric gate automation";

$extraContent = "include/electric-gate-motors-overview.php";
...
<h1>Electric Gate Motors and Gate Automation</h1>
<div style="float:right;width:380px">
    ...
    <div style="margin:15px">
        ...
        <p> Our <strong>Gate Motor Experts</strong> are standing by to help you get quotes and fix your broken gate motors.
        </p>
    </div>
    <!--content end -->
    <b class="rbottom">
